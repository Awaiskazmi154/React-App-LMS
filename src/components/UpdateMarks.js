...
const API2 = 'http://localhost:4000/teacher/updateresult/';
  ...
  return (
    ...
    <div className="row row-content">
        <div className="col-12">
           <h3>Select the Quiz No. and Student roll no. to Update the quiz Marks</h3>
        </div>
         ...
         <form>
                 ...
                 <div className="form-group row">
                     <div className="offset-md-2 col-md-10">
                         <button type="submit" onClick={this.updatemarks} className="btn btn-primary" >Update Quiz Marks</button>
                     </div>
                 </div>
             </form>
